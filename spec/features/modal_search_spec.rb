...
RSpec.describe 'ModalSearchDialog' do
  ...
  before do
    ...
    @original_outputs = Rails.configuration.x.dmproadmap.madmp.enable_research_outputs
    @original_repos = Rails.configuration.x.dmproadmap.madmp.enable_repository_selection
    Rails.configuration.x.dmproadmap.madmp.enable_research_outputs = true
    Rails.configuration.x.dmproadmap.madmp.enable_repository_selection = true
  ...
  after do
    Rails.configuration.x.dmproadmap.madmp.enable_research_outputs = @original_outputs
    Rails.configuration.x.dmproadmap.madmp.enable_repository_selection = @original_repos
  end

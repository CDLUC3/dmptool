...
module OrgSelectable
  ...
  included do
    ...
    def autocomplete_to_controller_params(namespace: nil)
      ...
      return {} if Rails.configuration.x.dmproadmap.application_restrict_orgs &&
                   current_user.blank?
      return {} if Rails.configuration.x.dmproadmap.application_restrict_orgs &&
    ...
    def process_org!(user: nil, managed_only: false, namespace: nil)
      ...
      if (user.present? && user.can_super_admin?) || !Rails.configuration.x.dmproadmap.application_restrict_orgs

...
class OrgsController < ApplicationController
  ...
  def shibboleth_ds_passthru
    # This action is used ONLY if Rails.configuration.x.dmproadmap.shibboleth_use_filtered_discovery_service
    # is true! It will attempt to redirect the user to the Rails.configuration.x.dmproadmap.shibboleth_login_url
  ...
  def shib_login_url
    Rails.configuration.x.dmproadmap.shibboleth_login_url
  end

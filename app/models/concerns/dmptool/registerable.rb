  ...
  module Registerable
    ...
    class_methods do
      ...
      def registration_enabled?
        Rails.configuration.x.dmproadmap.madmp.enable_dmp_id_registration
      end
      ...
      def orcid_publication_enabled?
        Rails.configuration.x.dmproadmap.madmp.enable_orcid_publication && !IdentifierScheme.where(name: 'orcid').first.nil?
      end
    end

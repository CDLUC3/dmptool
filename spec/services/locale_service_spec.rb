...
RSpec.describe LocaleService do
  before do
    ...
    @orignal_default = Rails.configuration.x.dmproadmap.locales.default
    @original_gettext = Rails.configuration.x.dmproadmap.locales.gettext_join_character
    @original_i18n = Rails.configuration.x.dmproadmap.locales.i18n_join_character
    Rails.configuration.x.dmproadmap.locales.default = @default.abbreviation
    Rails.configuration.x.dmproadmap.locales.gettext_join_character = '_'
    Rails.configuration.x.dmproadmap.locales.i18n_join_character = '-'
  end

  after do
    Rails.configuration.x.dmproadmap.locales.default = @orignal_default
    Rails.configuration.x.dmproadmap.locales.gettext_join_character = @original_gettext
    Rails.configuration.x.dmproadmap.locales.i18n_join_character = @original_i18n
  end

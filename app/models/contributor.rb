...
class Contributor < ApplicationRecord
  ...
  def name_or_email_presence
    errors.add(:name, _("can't be blank.")) if name.blank? && Rails.configuration.x.dmproadmap.application.require_contributor_name
    if email.blank? && Rails.configuration.x.dmproadmap.application.require_contributor_email
      errors.add(:email,
                 _("can't be blank."))
    end

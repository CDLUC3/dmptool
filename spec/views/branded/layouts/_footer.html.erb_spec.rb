...
describe 'layouts/_footer.html.erb' do
  ...
  it 'renders properly' do
    Rails.configuration.x.dmproadmap.dmptool_version = Faker::Number.number
    render
    ...
    expect(rendered.include?("Version: #{Rails.configuration.x.dmproadmap.dmptool_version}")).to be(true)
  end
end

...
RSpec.describe ExternalApis::OrcidService, type: :model do
  ...
  before do
    ...
    @original_active = Rails.configuration.x.dmproadmap.orcid_active
    @original_base_url = Rails.configuration.x.dmproadmap.orcid_api_base_url
    @original_landing = Rails.configuration.x.dmproadmap.orcid_landing_page_url
    @original_callback = Rails.configuration.x.dmproadmap.orcid_callback_path
    @original_work = Rails.configuration.x.dmproadmap.orcid_work_path
    Rails.configuration.x.dmproadmap.allow_dmp_id_minting = true
    Rails.configuration.x.dmproadmap.orcid_active = true
    Rails.configuration.x.dmproadmap.orcid_api_base_url = 'https://api.sandbox.orcid.org/v3.0/'
    Rails.configuration.x.dmproadmap.orcid_landing_page_url = Faker::Internet.url
    Rails.configuration.x.dmproadmap.orcid_callback_path = "/#{Faker::Lorem.word}/%{put_code}"
    Rails.configuration.x.dmproadmap.orcid_work_path = "/%{id}/#{Faker::Lorem.word}"
  ...
  after do
    ...
    Rails.configuration.x.dmproadmap.orcid_active = @original_active
    Rails.configuration.x.dmproadmap.orcid_api_base_url = @original_base_url
    Rails.configuration.x.dmproadmap.orcid_landing_page_url = @original_landing
    Rails.configuration.x.dmproadmap.orcid_callback_path = @original_callback
    Rails.configuration.x.dmproadmap.orcid_work_path = @original_work
  end

  ...
  class Re3dataService < BaseService
    class << self
      ...
      def landing_page_url
        Rails.configuration.x.dmproadmap.re3data_landing_page_url || super
      end

      def api_base_url
        Rails.configuration.x.dmproadmap.re3data_api_base_url || super
      end

      def max_pages
        Rails.configuration.x.dmproadmap.re3data_max_pages || super
      end

      def max_results_per_page
        Rails.configuration.x.dmproadmap.re3data_max_results_per_page || super
      end

      def max_redirects
        Rails.configuration.x.dmproadmap.re3data_max_redirects || super
      end

      def active?
        Rails.configuration.x.dmproadmap.re3data_active || super
      end

      def list_path
        Rails.configuration.x.dmproadmap.re3data_list_path
      end

      def repository_path
        Rails.configuration.x.dmproadmap.re3data_repository_path
      end

...
class RegistrationsController < Devise::RegistrationsController
  ...
  def create
    ...
    # blank_org = if Rails.configuration.x.dmproadmap.application_restrict_orgs
    ...
    #   use_recaptcha = Rails.configuration.x.dmproadmap.recaptcha_enabled || false
  ...
  #   restrict_orgs = Rails.configuration.x.dmproadmap.application_restrict_orgs

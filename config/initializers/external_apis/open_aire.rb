...
Rails.configuration.x.dmproadmap.open_aire_api_base_url = 'https://api.openaire.eu/'
# The api_url should contain `%s. This is where the funder is appended!
Rails.configuration.x.dmproadmap.open_aire_search_path = 'projects/dspace/%s/ALL/ALL'
Rails.configuration.x.dmproadmap.open_aire_default_funder = 'H2020'

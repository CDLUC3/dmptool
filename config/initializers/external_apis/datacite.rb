...
Rails.configuration.x.dmproadmap.datacite.description = 'The DataCite REST API: https://support.datacite.org/docs/api-create-dois'

# Credentials for minting DMP IDs via DataCite
# To disable this feature, simply set 'active' to false
Rails.configuration.x.dmproadmap.datacite.mint_path = 'dois'
Rails.configuration.x.dmproadmap.datacite.update_path = 'dois/'
Rails.configuration.x.dmproadmap.datacite.delete_path = 'dois/'
...
Rails.configuration.x.dmproadmap.datacite.hosting_institution = 'My Curation Centre (MCC)'
Rails.configuration.x.dmproadmap.datacite.hosting_institution_identifier = 'https://ror.org/12345'

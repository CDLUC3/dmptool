...
describe 'api/v1/datasets/_show.json.jbuilder' do
  ...
  context 'config has enabled madmp options' do
    before do
      Rails.configuration.x.dmproadmap.extract_preservation_statements_from_themed_questions = true
      Rails.configuration.x.dmproadmap.extract_security_privacy_statements_from_themed_questions = true
      Rails.configuration.x.dmproadmap.extract_data_quality_statements_from_themed_questions = true
